...
description: >-
  Four-phase debugging methodology with root cause analysis (Investigate, Pattern Analysis, Hypothesis & Test, Implementation). Enforces no fixes without root cause first.
---
