---
name: stop-making-ui-slop
description: >-
  Build distinctive UI/UX design avoiding generic AI defaults, using design contracts, clear hierarchy, real states, responsive layouts, and finish gates.
---
