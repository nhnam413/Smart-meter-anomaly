...
name: idea-refine
description: >-
  Refine raw ideas into sharp, actionable concepts through structured divergent and convergent thinking. Use when an idea is vague, to stress-test assumptions before committing to a plan, or to generate and converge on product options.
---
