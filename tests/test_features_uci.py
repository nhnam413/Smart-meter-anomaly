...
class UciFeatureTests(unittest.TestCase):
    ...
    def test_tc05_night_and_day_power_classification(self):
        ...
        cases = [
            ({**night_source, "voltage_diff_1h": 0, "is_night": 1,
              "power_zscore_6h": 1.0, "power_dev_24h": 0}, "night_spike"),
            ({**day_source, "voltage_diff_1h": 0, "is_night": 0,
              "power_zscore_6h": 1.0, "power_dev_24h": 1.0}, "power_surge"),
        ]
    ...
    def test_tc06_severity_is_bounded_monotonic_and_classified(self):
        ...
        boundaries = [(0.4999, "normal"), (0.5, "warning"),
                      (0.6999, "warning"), (0.7, "critical")]
